...
__STATIC_INLINE void pcm1792_AT_config(PCM1792_TypeDef *PCM1792, uint8_t ATL, uint8_t ATR, uint8_t atld, uint8_t write)
{
	...
	if( write == 1 )
	{
		pcm1792_writeReg(PCM1792_REG16_ADDR, PCM1792->REG16);
		pcm1792_writeReg(PCM1792_REG17_ADDR, PCM1792->REG17);
		pcm1792_writeReg(PCM1792_REG18_ADDR, PCM1792->REG18);
	}
...
__STATIC_INLINE void pcm1792_FMT_conf(PCM1792_TypeDef *PCM1792, uint8_t FMT, uint8_t write)
{
...
__STATIC_INLINE void pcm1792_DMF_conf(PCM1792_TypeDef *PCM1792, uint8_t DMF, uint8_t DME, uint8_t write)
{
...
__STATIC_INLINE void pcm1792_MUTE_conf(PCM1792_TypeDef *PCM1792, uint8_t MUTE, uint8_t write)
{
...
/* Reg 19 */
__STATIC_INLINE void pcm1792_REV_conf(PCM1792_TypeDef *PCM1792, uint8_t REV, uint8_t write)
{
	MODIFY_REG( PCM1792->REG19, PCM1792_Rev_Msk, REV );

	if( write == 1 )
	{
		pcm1792_writeReg(PCM1792_REG19_ADDR, PCM1792->REG19);
	}
}

__STATIC_INLINE void pcm1792_ATS_conf(PCM1792_TypeDef *PCM1792, uint8_t ATS, uint8_t write)
{
...
__STATIC_INLINE void pcm1792_OPE_conf(PCM1792_TypeDef *PCM1792, uint8_t OPE, uint8_t write)
{
...
__STATIC_INLINE void pcm1792_DFMS_conf(PCM1792_TypeDef *PCM1792, uint8_t DFMS, uint8_t write)
{
...
__STATIC_INLINE void pcm1792_FLT_conf(PCM1792_TypeDef *PCM1792, uint8_t FLT, uint8_t write)
{
...
__STATIC_INLINE void pcm1792_INZD_conf(PCM1792_TypeDef *PCM1792, uint8_t INZD, uint8_t write)
{
...
__STATIC_INLINE void pcm1792_SRST_conf(PCM1792_TypeDef *PCM1792, uint8_t SRST, uint8_t write)
{
	MODIFY_REG( PCM1792->REG20, PCM1792_SRST_Msk, SRST );

	if( write == 1 )
	{
		pcm1792_writeReg(PCM1792_REG20_ADDR, PCM1792->REG20);
	}
}

__STATIC_INLINE void pcm1792_DSD_conf(PCM1792_TypeDef *PCM1792, uint8_t DSD, uint8_t write)
{
...
__STATIC_INLINE void pcm1792_DFTH_conf(PCM1792_TypeDef *PCM1792, uint8_t DFTH, uint8_t write)
{
...
__STATIC_INLINE void pcm1792_MONO_conf(PCM1792_TypeDef *PCM1792, uint8_t MONO, uint8_t write)
{
...
__STATIC_INLINE void pcm1792_CHSL_conf(PCM1792_TypeDef *PCM1792, uint8_t CHSL, uint8_t write)
{
...
__STATIC_INLINE void pcm1792_OS_conf(PCM1792_TypeDef *PCM1792, uint8_t OS, uint8_t write)
{
...
__STATIC_INLINE void pcm1792_DZ_conf(PCM1792_TypeDef *PCM1792, uint8_t DZ, uint8_t write)
{
	MODIFY_REG( PCM1792->REG21, PCM1792_DZ_Msk, DZ );

	if( write == 1 )
	{
		pcm1792_writeReg(PCM1792_REG21_ADDR, PCM1792->REG21);
	}
}

__STATIC_INLINE void pcm1792_PCMZ_conf(PCM1792_TypeDef *PCM1792, uint8_t PCMZ, uint8_t write)
{
...
__STATIC_INLINE void PCM1792_StructInit(PCM1792_TypeDef *DEV, PCM1792_InitTypeDef *INIT)
{
	...
	pcm1792_writeReg(PCM1792_REG16_ADDR, DEV->REG16);
	pcm1792_writeReg(PCM1792_REG17_ADDR, DEV->REG17);
	pcm1792_writeReg(PCM1792_REG18_ADDR, DEV->REG18);
	pcm1792_writeReg(PCM1792_REG19_ADDR, DEV->REG19);
	pcm1792_writeReg(PCM1792_REG20_ADDR, DEV->REG20);
	pcm1792_writeReg(PCM1792_REG21_ADDR, DEV->REG21);
